 ...
 */
/**
 * jQuery.tagcanvas 2.8 For more information, please contact
 * <graham@goat1000.com>
 */
(function($){
"use strict";
...
/**
 * Creates a new canvas containing the image and its shadow Returns an object
 * containing the image and its dimensions at z=0
 */
...
/**
 * @constructor for recursively splitting tag contents on <br>
 *              tags
 */
...
function TagCanvas(cid,lctr,opt) {
  ...
  this.radius = min(c.height, c.width) * 0.0075; // fits radius of 100 in
													// canvas
  this.max_radius = 100;
  this.max_weight = [];
  this.min_weight = [];
